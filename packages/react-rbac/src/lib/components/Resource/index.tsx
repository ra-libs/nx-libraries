...
Resource.registerResource = (
  ...
  return {
    ...
    hasCreate:
      (!!create || !!hasCreate) &&
      ability.can(CASLAction.Create, permissionName),
    hasEdit:
      (!!edit || !!hasEdit) && ability.can(CASLAction.Update, permissionName),
    hasShow:
      (!!show || !!hasShow) && ability.can(CASLAction.Read, permissionName),
    icon,
    recordRepresentation,
  };
};
